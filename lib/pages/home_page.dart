...
import 'package:notes_app/models/labels_model.dart';
...
import 'package:notes_app/helpers/storage.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          children: [
            Container(
              decoration: BoxDecoration(
                color: darkModeOn
                    ? FlexColor.aquaBlueDarkPrimary.lighten(10).withOpacity(0.5)
                    : FlexColor.aquaBlueDarkPrimary.lighten(5).withOpacity(0.5),
              ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(
                        Iconsax.tag,
                        size: 80,
                        color: FlexColor.aquaBlueDarkPrimaryVariant,
                      ),
                      SizedBox(height: 20),
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: FlexColor.aquaBlueLightPrimaryVariant,
        elevation: 0,
        focusElevation: 0,
        hoverElevation: 0,
